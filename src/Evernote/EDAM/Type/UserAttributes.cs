...
namespace Evernote.EDAM.Type
{
  ...
  public partial class UserAttributes : TBase
  {
    ...
    /// <summary>
    /// 
    /// <seealso cref="ReminderEmailConfig"/>
    /// </summary>
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 35:
              if (field.Type == TType.I64) {
                EmailAddressLastConfirmed = iprot.ReadI64();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
            ...
            case 37:
              if (field.Type == TType.Bool) {
                SalesforcePushEnabled = iprot.ReadBool();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
            case 38:
              if (field.Type == TType.Bool) {
                ShouldLogClientEvent = iprot.ReadBool();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
            case 39:
              if (field.Type == TType.Bool) {
                OptOutMachineLearning = iprot.ReadBool();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (__isset.emailAddressLastConfirmed) {
          field.Name = "emailAddressLastConfirmed";
          field.Type = TType.I64;
          field.ID = 35;
          oprot.WriteFieldBegin(field);
          oprot.WriteI64(EmailAddressLastConfirmed);
          oprot.WriteFieldEnd();
        }
        if (__isset.passwordUpdated) {
          ...
          field.ID = 36;
          oprot.WriteFieldBegin(field);
          oprot.WriteI64(PasswordUpdated);
          oprot.WriteFieldEnd();
        }
        if (__isset.salesforcePushEnabled) {
          field.Name = "salesforcePushEnabled";
          field.Type = TType.Bool;
          field.ID = 37;
          oprot.WriteFieldBegin(field);
          oprot.WriteBool(SalesforcePushEnabled);
          oprot.WriteFieldEnd();
        }
        if (__isset.shouldLogClientEvent) {
          field.Name = "shouldLogClientEvent";
          field.Type = TType.Bool;
          field.ID = 38;
          oprot.WriteFieldBegin(field);
          oprot.WriteBool(ShouldLogClientEvent);
          oprot.WriteFieldEnd();
        }
        if (__isset.optOutMachineLearning) {
          field.Name = "optOutMachineLearning";
          field.Type = TType.Bool;
          field.ID = 39;
          oprot.WriteFieldBegin(field);
          oprot.WriteBool(OptOutMachineLearning);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("UserAttributes(");
      bool __first = true;
      if (DefaultLocationName != null && __isset.defaultLocationName) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DefaultLocationName: ");
        __sb.Append(DefaultLocationName);
      }
      if (__isset.defaultLatitude) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DefaultLatitude: ");
        __sb.Append(DefaultLatitude);
      }
      if (__isset.defaultLongitude) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DefaultLongitude: ");
        __sb.Append(DefaultLongitude);
      }
      if (__isset.preactivation) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Preactivation: ");
        __sb.Append(Preactivation);
      }
      if (ViewedPromotions != null && __isset.viewedPromotions) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ViewedPromotions: ");
        __sb.Append(ViewedPromotions);
      }
      if (IncomingEmailAddress != null && __isset.incomingEmailAddress) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("IncomingEmailAddress: ");
        __sb.Append(IncomingEmailAddress);
      }
      if (RecentMailedAddresses != null && __isset.recentMailedAddresses) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("RecentMailedAddresses: ");
        __sb.Append(RecentMailedAddresses);
      }
      if (Comments != null && __isset.comments) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Comments: ");
        __sb.Append(Comments);
      }
      if (__isset.dateAgreedToTermsOfService) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DateAgreedToTermsOfService: ");
        __sb.Append(DateAgreedToTermsOfService);
      }
      if (__isset.maxReferrals) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("MaxReferrals: ");
        __sb.Append(MaxReferrals);
      }
      if (__isset.referralCount) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ReferralCount: ");
        __sb.Append(ReferralCount);
      }
      if (RefererCode != null && __isset.refererCode) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("RefererCode: ");
        __sb.Append(RefererCode);
      }
      if (__isset.sentEmailDate) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("SentEmailDate: ");
        __sb.Append(SentEmailDate);
      }
      if (__isset.sentEmailCount) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("SentEmailCount: ");
        __sb.Append(SentEmailCount);
      }
      if (__isset.dailyEmailLimit) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("DailyEmailLimit: ");
        __sb.Append(DailyEmailLimit);
      }
      if (__isset.emailOptOutDate) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("EmailOptOutDate: ");
        __sb.Append(EmailOptOutDate);
      }
      if (__isset.partnerEmailOptInDate) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PartnerEmailOptInDate: ");
        __sb.Append(PartnerEmailOptInDate);
      }
      if (PreferredLanguage != null && __isset.preferredLanguage) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PreferredLanguage: ");
        __sb.Append(PreferredLanguage);
      }
      if (PreferredCountry != null && __isset.preferredCountry) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PreferredCountry: ");
        __sb.Append(PreferredCountry);
      }
      if (__isset.clipFullPage) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ClipFullPage: ");
        __sb.Append(ClipFullPage);
      }
      if (TwitterUserName != null && __isset.twitterUserName) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("TwitterUserName: ");
        __sb.Append(TwitterUserName);
      }
      if (TwitterId != null && __isset.twitterId) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("TwitterId: ");
        __sb.Append(TwitterId);
      }
      if (GroupName != null && __isset.groupName) {
        if(!__first) { __sb.Append(", "); }
      ...
      if (RecognitionLanguage != null && __isset.recognitionLanguage) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("RecognitionLanguage: ");
        __sb.Append(RecognitionLanguage);
      }
      if (ReferralProof != null && __isset.referralProof) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ReferralProof: ");
        __sb.Append(ReferralProof);
      }
      if (__isset.educationalDiscount) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("EducationalDiscount: ");
        __sb.Append(EducationalDiscount);
      }
      if (BusinessAddress != null && __isset.businessAddress) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("BusinessAddress: ");
        __sb.Append(BusinessAddress);
      }
      if (__isset.hideSponsorBilling) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("HideSponsorBilling: ");
        __sb.Append(HideSponsorBilling);
      }
      if (__isset.useEmailAutoFiling) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("UseEmailAutoFiling: ");
        __sb.Append(UseEmailAutoFiling);
      }
      if (__isset.reminderEmailConfig) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ReminderEmailConfig: ");
        __sb.Append(ReminderEmailConfig);
      }
      if (__isset.emailAddressLastConfirmed) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("EmailAddressLastConfirmed: ");
        __sb.Append(EmailAddressLastConfirmed);
      }
      if (__isset.passwordUpdated) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PasswordUpdated: ");
        __sb.Append(PasswordUpdated);
      }
      if (__isset.salesforcePushEnabled) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("SalesforcePushEnabled: ");
        __sb.Append(SalesforcePushEnabled);
      }
      if (__isset.shouldLogClientEvent) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("ShouldLogClientEvent: ");
        __sb.Append(ShouldLogClientEvent);
      }
      if (__isset.optOutMachineLearning) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("OptOutMachineLearning: ");
        __sb.Append(OptOutMachineLearning);
      }
      __sb.Append(")");
