...
namespace Evernote.EDAM.Type
{
  ...
  public partial class Accounting : TBase
  {
    ...
    /// <summary>
    /// 
    /// <seealso cref="PremiumOrderStatus"/>
    /// </summary>
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (__isset.availablePoints) {
          field.Name = "availablePoints";
          field.Type = TType.I32;
          field.ID = 25;
          oprot.WriteFieldBegin(field);
          oprot.WriteI32(AvailablePoints);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("Accounting(");
      bool __first = true;
      if (__isset.uploadLimitEnd) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("UploadLimitEnd: ");
        __sb.Append(UploadLimitEnd);
      }
      if (__isset.uploadLimitNextMonth) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("UploadLimitNextMonth: ");
        __sb.Append(UploadLimitNextMonth);
      }
      if (__isset.premiumServiceStatus) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumServiceStatus: ");
        __sb.Append(PremiumServiceStatus);
      }
      if (PremiumOrderNumber != null && __isset.premiumOrderNumber) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumOrderNumber: ");
        __sb.Append(PremiumOrderNumber);
      }
      if (PremiumCommerceService != null && __isset.premiumCommerceService) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumCommerceService: ");
        __sb.Append(PremiumCommerceService);
      }
      if (__isset.premiumServiceStart) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumServiceStart: ");
        __sb.Append(PremiumServiceStart);
      }
      if (PremiumServiceSKU != null && __isset.premiumServiceSKU) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumServiceSKU: ");
        __sb.Append(PremiumServiceSKU);
      }
      if (__isset.lastSuccessfulCharge) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("LastSuccessfulCharge: ");
        __sb.Append(LastSuccessfulCharge);
      }
      if (__isset.lastFailedCharge) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("LastFailedCharge: ");
        __sb.Append(LastFailedCharge);
      }
      if (LastFailedChargeReason != null && __isset.lastFailedChargeReason) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("LastFailedChargeReason: ");
        __sb.Append(LastFailedChargeReason);
      }
      if (__isset.nextPaymentDue) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("NextPaymentDue: ");
        __sb.Append(NextPaymentDue);
      }
      if (__isset.premiumLockUntil) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumLockUntil: ");
        __sb.Append(PremiumLockUntil);
      }
      if (__isset.updated) {
        if(!__first) { __sb.Append(", "); }
      ...
      if (PremiumSubscriptionNumber != null && __isset.premiumSubscriptionNumber) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("PremiumSubscriptionNumber: ");
        __sb.Append(PremiumSubscriptionNumber);
      }
      if (__isset.lastRequestedCharge) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("LastRequestedCharge: ");
        __sb.Append(LastRequestedCharge);
      }
      if (Currency != null && __isset.currency) {
        if(!__first) { __sb.Append(", "); }
      ...
      if (__isset.businessRole) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("BusinessRole: ");
        __sb.Append(BusinessRole);
      }
      if (__isset.unitDiscount) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("UnitDiscount: ");
        __sb.Append(UnitDiscount);
      }
      if (__isset.nextChargeDate) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("NextChargeDate: ");
        __sb.Append(NextChargeDate);
      }
      if (__isset.availablePoints) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("AvailablePoints: ");
        __sb.Append(AvailablePoints);
      }
      __sb.Append(")");
